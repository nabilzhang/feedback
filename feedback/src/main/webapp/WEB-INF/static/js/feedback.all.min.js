...
// Feedback
!function(e,t,a){if(e.Feedback===a){var n,i=function(t){e.console.log(t)},o=function(e){for(var t=0,n=e.length;n>t;t++){var i=Array.prototype.pop.call(e);i!==a&&null!==i.parentNode&&i.parentNode.removeChild(i)}},r=function(){var e=t.createElement("div"),a=3;for(e.className="feedback-loader";a--;)e.appendChild(t.createElement("span"));return e},l=function(e){for(var t;null!==(t=e.firstChild)?e.removeChild(t):!1;);},s=function(e,a,n){var i=t.createElement(e);return a&&i.appendChild(t.createTextNode(a)),n&&(i.className=n),i},d=function(t,n){if(t.onload!==a)return n;if(t.onreadystatechange!==a){var o=function(){"loaded"!==t.readyState&&"complete"!==t.readyState?e.setTimeout(o,250):n()};e.setTimeout(o,250)}else i("ERROR: We can't track when script is loaded")},c="data-html2canvas-ignore",h=t.createElement("div");e.Feedback=function(i){i=i||{},i.label=i.label||"意见反馈",i.header=i.header||"意见反馈 ",i.url=i.url||"/",i.adapter=i.adapter||new e.Feedback.XHR(i),i.nextLabel=i.nextLabel||"下一步",i.reviewLabel=i.reviewLabel||"预览",i.sendLabel=i.sendLabel||"发送",i.closeLabel=i.closeLabel||"关闭",i.messageSuccess=i.messageSuccess||"发送成功！",i.messageError=i.messageError||"发送失败",i.pages===a&&(i.pages=[new e.Feedback.Form,new e.Feedback.Screenshot(i),new e.Feedback.Review]);var d,p,b,f=t.createElement("div"),u={open:function(){var a=i.pages.length;for(b=0;a>b;b++)i.pages[b]instanceof e.Feedback.Review||i.pages[b].render();var o=s("a","x"),r=t.createElement("div"),v=t.createElement("div");p=t.createElement("div"),t.body.appendChild(f),o.className="feedback-close",o.onclick=u.close,o.href="#",d.disabled=!0,r.appendChild(o),r.appendChild(s("h3",i.header)),r.className="feedback-header",h.className="feedback-body",l(h),b=0,h.appendChild(i.pages[b++].dom),n=s("button",i.nextLabel),n.className="feedback-btn",n.onclick=function(){b>0&&i.pages[b-1].end(p)===!1||(l(h),b===a?u.send(i.adapter):(i.pages[b].start(p,r,v,n),i.pages[b]instanceof e.Feedback.Review&&i.pages[b].render(i.pages),h.appendChild(i.pages[b++].dom),b===a&&(n.firstChild.nodeValue=i.sendLabel),i.pages[b]instanceof e.Feedback.Review&&(n.firstChild.nodeValue=i.reviewLabel)))},v.className="feedback-footer",v.appendChild(n),p.className="feedback-modal",p.setAttribute(c,!0),p.appendChild(r),p.appendChild(h),p.appendChild(v),t.body.appendChild(p)},close:function(){d.disabled=!1,o([p,f]),b>0&&i.pages[b-1].end(p);for(var e=0,t=i.pages.length;t>e;e++)i.pages[e].close();return!1},send:function(a){if(!(a instanceof e.Feedback.Send))throw new Error("Adapter is not an instance of Feedback.Send");for(var o,s=0,d=i.pages.length,c=[],p=0;d>s;s++)(o=i.pages[s].data())!==!1&&(c[p++]=o);n.disabled=!0,l(h),h.appendChild(r()),a.send(c,function(e){l(h),n.disabled=!1,n.firstChild.nodeValue=i.closeLabel,n.onclick=function(){return u.close(),!1},e===!0?h.appendChild(t.createTextNode(i.messageSuccess)):h.appendChild(t.createTextNode(i.messageError))})}};return f.className="feedback-glass",f.style.pointerEvents="none",f.setAttribute(c,!0),i=i||{},d=s("button",i.label),d.className="feedback-btn feedback-bottom-right",d.setAttribute(c,!0),d.onclick=u.open,null!==i.appendTo&&(i.appendTo!==a?i.appendTo:t.body).appendChild(d),u},e.Feedback.Page=function(){},e.Feedback.Page.prototype={render:function(e){this.dom=e},start:function(){},close:function(){},data:function(){return!1},review:function(){return null},end:function(){return!0}},e.Feedback.Send=function(){},e.Feedback.Send.prototype={send:function(){}},e.Feedback.Form=function(e){this.elements=e||[{type:"input",name:"UserName",label:"称呼",required:!0,value:"雷锋"},{type:"input",name:"Email",label:"联系邮件",required:!1},{type:"input",name:"Title",label:"标题",required:!0},{type:"textarea",name:"Issue",label:"您想说点什么？",required:!1}],this.dom=t.createElement("div")},e.Feedback.Form.prototype=new e.Feedback.Page,e.Feedback.Form.prototype.render=function(){var e,a=0,n=this.elements.length;for(l(this.dom);n>a;a++){switch(e=this.elements[a],e.type){case"textarea":this.dom.appendChild(s("label",e.label+":"+(e.required===!0?"":""),"block-label")),this.dom.appendChild(e.element=t.createElement("textarea"));break;case"input":this.dom.appendChild(s("label",e.label+":"+(e.required===!0?"":""),"block-label")),this.dom.appendChild(e.element=t.createElement("input")),e.element.type="text"}e.value&&(e.element.value=e.value)}return this},e.Feedback.Form.prototype.end=function(){for(var e,t=0,a=this.elements.length;a>t;t++){if(e=this.elements[t],e.required===!0&&0===e.element.value.length)return e.element.className="feedback-error",!1;e.element.className=""}return!0},e.Feedback.Form.prototype.data=function(){if(this._data!==a)return this._data;for(var e,t=0,n=this.elements.length,i={};n>t;t++)e=this.elements[t],i[e.name]=e.element.value;return this._data=i},e.Feedback.Form.prototype.review=function(e){for(var a,n=0,i=this.elements.length;i>n;n++)a=this.elements[n],a.element.value.length>0&&(e.appendChild(s("label",a.label+": ","label-bold")),e.appendChild(t.createTextNode(a.element.value)),e.appendChild(t.createElement("hr")));return e},e.Feedback.Review=function(){this.dom=t.createElement("div"),this.dom.className="feedback-review"},e.Feedback.Review.prototype=new e.Feedback.Page,e.Feedback.Review.prototype.render=function(e){var t=0,a=e.length;for(l(this.dom);a>t;t++)e[t].review(this.dom);return this},e.Feedback.Screenshot=function(e){this.options=e||{},this.options.blackoutClass=this.options.blackoutClass||"feedback-blackedout",this.options.highlightClass=this.options.highlightClass||"feedback-highlighted",this.h2cDone=!1},e.Feedback.Screenshot.prototype=new e.Feedback.Page,e.Feedback.Screenshot.prototype.end=function(e){e.className=e.className.replace(/feedback\-animate\-toside/,""),o([this.h2cCanvas]),o([t.getElementById("fb_canvas_container")]),this.h2cDone=!1},e.Feedback.Screenshot.prototype.close=function(){o([this.blackoutBox,this.highlightContainer,this.highlightBox,this.highlightClose]),o(t.getElementsByClassName(this.options.blackoutClass)),o(t.getElementsByClassName(this.options.highlightClass))},e.Feedback.Screenshot.prototype.start=function(a,n,i,d){if(this.h2cDone){l(this.dom),d.disabled=!1;var c=this,h="active_fb_box",p="active_fb_text",b="active_fb_arrow",f="active_fb_free",u="",v="active_fb_black";white_id="active_fb_white",red_id="active_fb_red",yellow_id="active_fb_yellow",blue_id="active_fb_blue",activeColor="yellow",clearActive=function(e){for(var t=c.dom.getElementsByClassName(e),a=0,n=t.length;n>a;a++)t[a].className="feedback-btn feedback-btn-small "+e},buttonClickFunction=function(e){var t=e.target;u=t.id,clearActive("tool-btn"),t.className+=" active",k.isDrawingMode&&t.id!=f&&(k.isDrawingMode=!1),t.id==f&&(k.isDrawingMode=!0)},boxButton=s("button","框"),textButton=s("button","文字"),arrowButton=s("button","箭头"),freeDrawButton=s("button","画笔"),fbEditorContainer=t.createElement("div"),fbCanvasEditor=t.createElement("canvas"),fbStyle=fbEditorContainer.style,a.className+=" feedback-animate-toside",this.h2cCanvas.className="feedback-canvas",t.body.appendChild(this.h2cCanvas),fbStyle.position="absolute",fbStyle.left=fbStyle.top="0px",fbStyle.zIndex="2000",fbEditorContainer.id="fb_canvas_container",fbCanvasEditor.id="fb_canvas",fbCanvasEditor.width=this.h2cCanvas.width,fbCanvasEditor.height=this.h2cCanvas.height,fbEditorContainer.appendChild(fbCanvasEditor),t.body.appendChild(fbEditorContainer);var m,g,k=new fabric.Canvas("fb_canvas"),C=!1;k.freeDrawingBrush=new fabric.PencilBrush(k),k.freeDrawingBrush.color="yellow",k.freeDrawingBrush.width=20,t.addEventListener("keydown",function(e){var t;46==e.keyCode&&"TEXTAREA"!==e.target.tagName&&(t=k.getActiveObject(),t&&k.remove(t)),27==e.keyCode&&(k.isDrawingMode=!1)}),fbEditorContainer.addEventListener("dblclick",function(){var e,a,n,i=k.getActiveObject();i&&i instanceof fabric.Text&&(n=i.getBoundingRect(),e=s("textarea"),a=e.style,a.position="absolute",a.left=n.left+"px",a.top=n.top+"px",a.width=n.width+"px",a.height=n.height+"px",a.zIndex=2001,e.value=i.text,t.body.appendChild(e),e.focus(),e.addEventListener("blur",function(){i.setText(e.value),k.setActiveObject(i),o([e])}))}),k.on("mouse:down",function(e){var t,a=e.e;if(!C){switch(C=!0,m={pageX:a.pageX,pageY:a.pageY},u){case p:t=new fabric.Text("修改文本, \r\n请双击文本框",{top:m.pageY,left:m.pageX,fill:activeColor,width:300,cornerColor:"yellow",cornerSize:12,transparentCorners:!1});break;case b:t=new fabric.Polygon([{x:30,y:0},{x:0,y:30},{x:20,y:30},{x:20,y:100},{x:40,y:100},{x:40,y:30},{x:60,y:30}],{top:m.pageY,left:m.pageX,fill:activeColor,angle:45,cornerColor:"yellow",cornerSize:12,transparentCorners:!1})}t&&(u="",k.add(t),clearActive("tool-btn"))}}),k.on("mouse:up",function(e){C=!1;var t,a,n,i=e.e;switch(g={pageX:i.pageX,pageY:i.pageY},t=g.pageY-m.pageY,a=g.pageX-m.pageX,u){case h:n=new fabric.Rect({top:m.pageY,left:m.pageX,width:a,height:t,stroke:activeColor,strokeWidth:12,fill:"rgba(0,0,0,0)",cornerColor:"yellow",cornerSize:12,transparentCorners:!1})}u="",n&&(k.add(n),clearActive("tool-btn"))}),this.fbCanvas=fbCanvasEditor,boxButton.id=h,textButton.id=p,arrowButton.id=b,freeDrawButton.id=f;var y=[boxButton,textButton,arrowButton,freeDrawButton],w=s("div"),F=s("div",""),E=s("a","B"),x=s("a","W"),_=s("a","R"),N=s("a","Y"),S=s("a","B"),B=(s("div"),[E,x,_,N,S]),R=function(e){e.preventDefault(),activeColor=e.target.id.replace("active_fb_",""),clearActive("color-btn"),e.target.className+=" active",activeObject=k.getActiveObject(),activeObject?(activeObject instanceof fabric.Rect?activeObject.setStroke(activeColor):activeObject.setFill(activeColor),k.renderAll()):k.isDrawingMode&&(k.freeDrawingBrush.color=activeColor)};E.id=v,E.style.background=E.style.color="black",x.id=white_id,x.style.background=x.style.color="white",_.id=red_id,_.style.background=_.style.color="red",N.id=yellow_id,N.style.background=N.style.color="yellow",S.id=blue_id,S.style.background=S.style.color="blue";for(var D,T=0,L=B.length;L>T;T++)D=B[T],D.href="#",D.onclick=R,D.className="feedback-btn feedback-btn-small color-btn",F.appendChild(B[T]);for(w.appendChild(s("label","颜色")),w.appendChild(F),this.dom.appendChild(w),this.dom.appendChild(s("p","画图工具")),T=0,L=y.length;L>T;T++)y[T].className="feedback-btn feedback-btn-small tool-btn",y[T].href="#",y[T].onclick=buttonClickFunction,this.dom.appendChild(y[T])}else{var X=arguments,c=this;d.disabled!==!0&&this.dom.appendChild(r()),d.disabled=!0,e.setTimeout(function(){c.start.apply(c,X)},500)}},e.Feedback.Screenshot.prototype.render=function(){this.dom=t.createElement("div");var n,o=this,r=this.options,l=function(){try{r.onrendered=r.onrendered||function(e){o.h2cCanvas=e,o.h2cDone=!0},e.html2canvas([t.body],r)}catch(a){o.h2cDone=!0,i("Error in html2canvas: "+a.message)}};if(e.html2canvas===a&&n===a){n=t.createElement("script"),n.src=r.h2cPath||"libs/html2canvas.js",n.onerror=function(){i("Failed to load html2canvas library, check that the path is correctly defined")},n.onload=d(n,function(){return e.html2canvas===a?(i("Loaded html2canvas, but library not found"),void 0):(e.html2canvas.logging=e.Feedback.debug,l(),void 0)});var s=t.getElementsByTagName("script")[0];s.parentNode.insertBefore(n,s)}else l();return this},e.Feedback.Screenshot.prototype.data=function(){if(this.h2cCanvas!==a){var e=this.h2cCanvas.getContext("2d");e.fillStyle="#000",e.drawImage(this.fbCanvas,0,0);try{return this._data=this.h2cCanvas.toDataURL("image/jpeg",.5)}catch(t){}}},e.Feedback.Screenshot.prototype.review=function(e){var t=this.data();if(t!==a){var n=new Image;n.src=t,n.style.width="300px",e.appendChild(n)}},e.Feedback.XHR=function(t){this.xhr=e.XMLHttpRequest?new XMLHttpRequest:e.window.XDomainRequest?new e.XDomainRequest:new ActiveXObject("Microsoft.XMLHTTP"),this.url=t.url,this.apikey=t.apikey},e.Feedback.XHR.prototype=new e.Feedback.Send,e.Feedback.XHR.prototype.send=function(e,t){function a(e){var t=[];for(var a in e)t.push(encodeURIComponent(a)+"="+encodeURIComponent(e[a]));return t.join("&")}var n=this.xhr;n.onreadystatechange=function(){4==n.readyState&&t(200===n.status)},e.apikey=this.apikey,console.log(e),n.open("POST",this.url,!0),n.setRequestHeader("Content-type","application/x-www-form-urlencoded");var i=e[0];n.send(a({title:i.Title,content:i.Issue,token:this.apikey,email:i.Email,nick:i.UserName,image:e[1]}))}}}(window,document);
